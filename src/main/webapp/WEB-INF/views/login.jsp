...
<head>
	...
	<link href="<c:url value='/template/docs/4.0/examples/sign-in/signin.css' />" rel="stylesheet">
</head>
...
<body class="text-center">
	...
	<form class="form-signin" action="j_spring_security_check" method="post">
		...
		<input type="text" id="inputEmail" class="form-control" name="j_username" placeholder="Email address" required autofocus>
